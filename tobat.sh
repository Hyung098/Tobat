...
#link izin ip vps
url_izin='https://raw.githubusercontent.com/Hyung098/Hyung098.github.io/main/ip'
...
<br><font color="#674FA3"> 𝐋𝐀𝐖𝐎𝐍 𝐕𝐏𝐍 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋</font></br>
END
...
# set uuid
wget -O /etc/xray/xray.json https://raw.githubusercontent.com/Hyung098/Tobat/main/xray.json
wget -O /etc/xray/v2ray.json https://raw.githubusercontent.com/Hyung098/Tobat/main/v2ray.json
clear
...
#nginx config
wget -O /etc/nginx/conf.d/xray.conf https://raw.githubusercontent.com/Hyung098/Tobat/main/xray.conf
...
rm -fr menu
rm -fr /usr/sbin/menu
wget https://raw.githubusercontent.com/Hyung098/Tobat/main/funny.zip
unzip funny.zip
rm -fr funny.zip
clear
cd /usr/local/bin
wget https://raw.githubusercontent.com/Hyung098/Tobat/main/ws.zip
unzip ws.zip
rm -fr ws.zip
chmod +x *
chmod +x /usr/bin/*
cd /etc/systemd/system
wget https://raw.githubusercontent.com/Hyung098/Tobat/main/service.zip
unzip service.zip
rm -fr service.zip
systemctl daemon-reload
